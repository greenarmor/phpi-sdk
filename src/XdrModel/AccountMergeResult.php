...
class AccountMergeResult extends OperationResult
{
    ...
    /**
     * Amount of PI transferred from the source account to the destination account
     *
     * @var PiAmount
     */
    ...
    public static function fromXdr(XdrBuffer $xdr)
    {
        ...
        $model->transferredBalance = new PiAmount(new BigInteger($xdr->readInteger64()));
    ...
    /**
     * @param PiAmount $transferredBalance
     */
