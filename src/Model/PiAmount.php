 ...
 *
 * Although displayed to the user as 1 PI, this value is stored in the protocol
...
class PiAmount
{
    ...
    {
        return new PiAmount(new BigInteger('9223372036854775807'));
    }

    /**
     * Reads a PiAmount from a SIGNED 64-bit integer
     *
     * @param XdrBuffer $xdr
     * @return PiAmount
    ...
    {
        return new PiAmount(new BigInteger($xdr->readInteger64()));
    }

    /**
     * PiAmount constructor.
     *
    ...
    public function __construct($lumensOrBigIntegerStroops)
    {
        ...
        // Can also pass in another PiAmount
        else if ($lumensOrBigIntegerStroops instanceof PiAmount) {
        ...
        if ($compared > 0) {
            throw new \InvalidArgumentException('Maximum value exceeded. Value cannot be larger than 9223372036854775807 stroops (922337203685.4775807 PI)');
        }
