 ...
 *
 * Notes:
 *  - Per-operation fee is 100 stroops (0.00001 PI)
 *  - Base reserve is 10 PI
 *      - Minimum balance for an account is base reserve * 2
 *      - Each additional trustline, offer, signer, and data entry requires another 10 PI
 *
 *
...
class TransactionBuilder implements XdrEncodableInterface
{
    ...
    public function getFee()
    {
        ...
        return 100000 * $this->operations->count();
    }
